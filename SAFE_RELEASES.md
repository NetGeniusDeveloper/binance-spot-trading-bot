...
Add scanner agent watchlist report
...
tag: scanner-safe-watchlist-report-v1
commit: 746bb16
branch: main
...
scanner-safe-project-status-watchlist-report-v1
...
tag: scanner-safe-risk-filter-backtest-v1
commit: 308835c
branch: main
...
scanner-safe-project-status-risk-filter-backtest-v1

Commands:

git tag -a scanner-safe-project-status-risk-filter-backtest-v1 -m "Stable project status after scanner-safe-risk-filter-backtest-v1"
git push origin scanner-safe-project-status-risk-filter-backtest-v1
...
Add risk filter backtest to safe release checks
...
tag: scanner-safe-release-backtest-check-v1
commit: a06a6fa
branch: main
...
scanner-safe-project-status-release-backtest-check-v1

Commands:

git tag -a scanner-safe-project-status-release-backtest-check-v1 -m "Stable project status after scanner-safe-release-backtest-check-v1"
git push origin scanner-safe-project-status-release-backtest-check-v1
...
Add synthetic scenarios to risk filter backtest
...
tag: scanner-safe-risk-filter-synthetic-scenarios-v1
commit: 2a3b5f1
branch: main
...
scanner-safe-project-status-risk-filter-synthetic-scenarios-v1

Commands:

git tag -a scanner-safe-project-status-risk-filter-synthetic-scenarios-v1 -m "Stable project status after scanner-safe-risk-filter-synthetic-scenarios-v1"
git push origin scanner-safe-project-status-risk-filter-synthetic-scenarios-v1
...
Move risk filter synthetic scenarios to JSON
...
tag: scanner-safe-risk-filter-scenarios-json-v1
commit: 96c172f
branch: main
...
scanner-safe-project-status-risk-filter-scenarios-json-v1
...
### scanner-safe-scenario-matrix-report-v1
...
tag: scanner-safe-scenario-matrix-report-v1
commit: 8b24510
branch: main
...
scanner-safe-project-status-scenario-matrix-report-v1
...
tag: scanner-safe-quick-dashboard-v1
commit: 429802e
branch: main
...
scanner-safe-project-status-quick-dashboard-v1

Commands:

git tag -a scanner-safe-project-status-quick-dashboard-v1 -m "Stable project status after scanner-safe-quick-dashboard-v1"
git push origin scanner-safe-project-status-quick-dashboard-v1
...
Add decision cockpit to quick dashboard
...
tag: scanner-safe-decision-cockpit-v1
commit: 4477a21
branch: main
...
scanner-safe-project-status-decision-cockpit-v1

Commands:

git tag -a scanner-safe-project-status-decision-cockpit-v1 -m "Stable project status after scanner-safe-decision-cockpit-v1"
git push origin scanner-safe-project-status-decision-cockpit-v1
...
Update project status after scanner-safe-decision-cockpit-gap-fields-fix-v1
...
tag: scanner-safe-project-status-decision-cockpit-gap-fields-fix-v1
commit: d771c39
branch: main
...
scanner-safe-project-status-project-status-decision-cockpit-gap-fields-fix-v1
...
### scanner-safe-manual-review-cards-pipeline-v1

Purpose:

Integrate manual review cards into safe pipeline
...
tag: scanner-safe-manual-review-cards-pipeline-v1
commit: d4a6134
branch: main
...
scanner-safe-project-status-manual-review-cards-pipeline-v1
...
Russian manual review cards report
...
tag: scanner-safe-manual-review-cards-russian-v1
commit: 161bae9
branch: main
...
scanner-safe-project-status-manual-review-cards-russian-v1
...
Add manager brief inline to quick dashboard
...
tag: scanner-safe-dashboard-manager-brief-inline-v1
commit: 4f66f1a
branch: main
...
scanner-safe-project-status-dashboard-manager-brief-inline-v1

Commands:

git tag -a scanner-safe-project-status-dashboard-manager-brief-inline-v1 -m "Stable project status after scanner-safe-dashboard-manager-brief-inline-v1"
git push origin scanner-safe-project-status-dashboard-manager-brief-inline-v1
...
Add manager brief to quick dashboard console output
...
tag: scanner-safe-dashboard-manager-brief-console-v1
commit: 8885d28
branch: main
...
scanner-safe-project-status-dashboard-manager-brief-console-v1
