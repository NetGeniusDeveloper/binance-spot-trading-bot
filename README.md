...
## Карта стабильных релизов

Подробная карта стабильных безопасных релизов проекта находится в файле:

SAFE_RELEASES.md

В этом файле указаны:

- стабильные теги проекта;
- назначение каждого релиза;
- команды проверки;
- команды отката;
- правила безопасного cron-запуска;
- правила Telegram safety flags;
- описание blocked risk отчётов;
- актуальная стабильная база для дальнейшей разработки.
